...
public class JwtService {
    ...
    public String generateToken(Map<String, Object> extraClaims, ClientDetails clientDetails) {
        return Jwts.builder()
    ...
    public boolean isTokenValid(String token, ClientDetails clientDetails) {
